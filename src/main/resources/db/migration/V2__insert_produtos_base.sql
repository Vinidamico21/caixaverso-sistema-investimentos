...
-- PERFIS DE RISCO
------------------------------------------------------------
INSERT INTO dbo.PerfilRisco (codigo, nome, descricao)
SELECT 'CONSERVADOR', 'Conservador', 'Perfil focado em segurança, liquidez e baixa volatilidade'
WHERE NOT EXISTS (SELECT 1 FROM dbo.PerfilRisco WHERE codigo = 'CONSERVADOR');

INSERT INTO dbo.PerfilRisco (codigo, nome, descricao)
SELECT 'MODERADO', 'Moderado', 'Perfil equilibrado entre segurança e retorno'
WHERE NOT EXISTS (SELECT 1 FROM dbo.PerfilRisco WHERE codigo = 'MODERADO');

INSERT INTO dbo.PerfilRisco (codigo, nome, descricao)
SELECT 'AGRESSIVO', 'Agressivo', 'Perfil focado em maior retorno com maior risco'
WHERE NOT EXISTS (SELECT 1 FROM dbo.PerfilRisco WHERE codigo = 'AGRESSIVO');


------------------------------------------------------------
-- PRODUTOS DE INVESTIMENTO ADICIONAIS
------------------------------------------------------------
...
------------------------------------------------------------
-- PARÂMETROS DO MOTOR DE RISCO (ATUALIZADO)
-- AGORA APENAS NOME + DESCRIÇÃO
------------------------------------------------------------

INSERT INTO dbo.ParametrosRisco (nome, descricao)
SELECT 'PESO_RENDA_BAIXA_CONSERVADOR', 'Peso aplicado quando renda é baixa, afeta cálculo do score conservador'
WHERE NOT EXISTS (SELECT 1 FROM dbo.ParametrosRisco WHERE nome = 'PESO_RENDA_BAIXA_CONSERVADOR');

INSERT INTO dbo.ParametrosRisco (nome, descricao)
SELECT 'PESO_RENDA_ALTA_AGRESSIVO', 'Peso aplicado quando renda é alta, afeta cálculo do score agressivo'
WHERE NOT EXISTS (SELECT 1 FROM dbo.ParametrosRisco WHERE nome = 'PESO_RENDA_ALTA_AGRESSIVO');

INSERT INTO dbo.ParametrosRisco (nome, descricao)
SELECT 'LIMIAR_SCORE_CONSERVADOR', 'Limiar usado para classificar o perfil como CONSERVADOR'
WHERE NOT EXISTS (SELECT 1 FROM dbo.ParametrosRisco WHERE nome = 'LIMIAR_SCORE_CONSERVADOR');

INSERT INTO dbo.ParametrosRisco (nome, descricao)
SELECT 'LIMIAR_SCORE_MODERADO', 'Limiar usado para classificar o perfil como MODERADO'
WHERE NOT EXISTS (SELECT 1 FROM dbo.ParametrosRisco WHERE nome = 'LIMIAR_SCORE_MODERADO');



------------------------------------------------------------
-- PESOS POR PERFIL X TIPO DE PRODUTO
------------------------------------------------------------

-- PERFIL CONSERVADOR
INSERT INTO dbo.PesosRecomendacao (perfil_risco, tipo_produto, peso)
SELECT 'CONSERVADOR', 'TESOURO', 0.9
WHERE NOT EXISTS (SELECT 1 FROM dbo.PesosRecomendacao WHERE perfil_risco='CONSERVADOR' AND tipo_produto='TESOURO');

INSERT INTO dbo.PesosRecomendacao (perfil_risco, tipo_produto, peso)
SELECT 'CONSERVADOR', 'CDB', 0.8
WHERE NOT EXISTS (SELECT 1 FROM dbo.PesosRecomendacao WHERE perfil_risco='CONSERVADOR' AND tipo_produto='CDB');

INSERT INTO dbo.PesosRecomendacao (perfil_risco, tipo_produto, peso)
SELECT 'CONSERVADOR', 'LCI', 0.7
WHERE NOT EXISTS (SELECT 1 FROM dbo.PesosRecomendacao WHERE perfil_risco='CONSERVADOR' AND tipo_produto='LCI');

INSERT INTO dbo.PesosRecomendacao (perfil_risco, tipo_produto, peso)
SELECT 'CONSERVADOR', 'FUNDO', 0.3
WHERE NOT EXISTS (SELECT 1 FROM dbo.PesosRecomendacao WHERE perfil_risco='CONSERVADOR' AND tipo_produto='FUNDO');

INSERT INTO dbo.PesosRecomendacao (perfil_risco, tipo_produto, peso)
SELECT 'CONSERVADOR', 'ACAO', 0.1
WHERE NOT EXISTS (SELECT 1 FROM dbo.PesosRecomendacao WHERE perfil_risco='CONSERVADOR' AND tipo_produto='ACAO');


-- PERFIL MODERADO
INSERT INTO dbo.PesosRecomendacao (perfil_risco, tipo_produto, peso)
SELECT 'MODERADO', 'TESOURO', 0.4
WHERE NOT EXISTS (SELECT 1 FROM dbo.PesosRecomendacao WHERE perfil_risco='MODERADO' AND tipo_produto='TESOURO');

INSERT INTO dbo.PesosRecomendacao (perfil_risco, tipo_produto, peso)
SELECT 'MODERADO', 'CDB', 0.6
WHERE NOT EXISTS (SELECT 1 FROM dbo.PesosRecomendacao WHERE perfil_risco='MODERADO' AND tipo_produto='CDB');

INSERT INTO dbo.PesosRecomendacao (perfil_risco, tipo_produto, peso)
SELECT 'MODERADO', 'LCI', 0.6
WHERE NOT EXISTS (SELECT 1 FROM dbo.PesosRecomendacao WHERE perfil_risco='MODERADO' AND tipo_produto='LCI');

INSERT INTO dbo.PesosRecomendacao (perfil_risco, tipo_produto, peso)
SELECT 'MODERADO', 'FUNDO', 0.7
WHERE NOT EXISTS (SELECT 1 FROM dbo.PesosRecomendacao WHERE perfil_risco='MODERADO' AND tipo_produto='FUNDO');

INSERT INTO dbo.PesosRecomendacao (perfil_risco, tipo_produto, peso)
SELECT 'MODERADO', 'ACAO', 0.5
WHERE NOT EXISTS (SELECT 1 FROM dbo.PesosRecomendacao WHERE perfil_risco='MODERADO' AND tipo_produto='ACAO');


-- PERFIL AGRESSIVO
INSERT INTO dbo.PesosRecomendacao (perfil_risco, tipo_produto, peso)
SELECT 'AGRESSIVO', 'TESOURO', 0.1
WHERE NOT EXISTS (SELECT 1 FROM dbo.PesosRecomendacao WHERE perfil_risco='AGRESSIVO' AND tipo_produto='TESOURO');

INSERT INTO dbo.PesosRecomendacao (perfil_risco, tipo_produto, peso)
SELECT 'AGRESSIVO', 'CDB', 0.3
WHERE NOT EXISTS (SELECT 1 FROM dbo.PesosRecomendacao WHERE perfil_risco='AGRESSIVO' AND tipo_produto='CDB');

INSERT INTO dbo.PesosRecomendacao (perfil_risco, tipo_produto, peso)
SELECT 'AGRESSIVO', 'LCI', 0.3
WHERE NOT EXISTS (SELECT 1 FROM dbo.PesosRecomendacao WHERE perfil_risco='AGRESSIVO' AND tipo_produto='LCI');

INSERT INTO dbo.PesosRecomendacao (perfil_risco, tipo_produto, peso)
SELECT 'AGRESSIVO', 'FUNDO', 0.7
WHERE NOT EXISTS (SELECT 1 FROM dbo.PesosRecomendacao WHERE perfil_risco='AGRESSIVO' AND tipo_produto='FUNDO');

INSERT INTO dbo.PesosRecomendacao (perfil_risco, tipo_produto, peso)
SELECT 'AGRESSIVO', 'ACAO', 0.9
WHERE NOT EXISTS (SELECT 1 FROM dbo.PesosRecomendacao WHERE perfil_risco='AGRESSIVO' AND tipo_produto='ACAO');
